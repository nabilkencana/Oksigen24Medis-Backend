...
async function main() {
  ...
  const oxygenTypes = [
    ...
    { name: 'Isi Ulang Tabung Oksigen 0.3m3', purity: 99.50, pressure: 150.00, pricePerUnit: 25000.00, description: 'Isi Ulang Gas Oksigen Medis Tabung 0.3m3' },
    { name: 'Isi Ulang Tabung Oksigen 0.5m3', purity: 99.50, pressure: 150.00, pricePerUnit: 25000.00, description: 'Isi Ulang Gas Oksigen Medis Tabung 0.5m3' },
    { name: 'Isi Ulang Tabung Oksigen 1m3', purity: 99.50, pressure: 150.00, pricePerUnit: 50000.00, description: 'Isi Ulang Gas Oksigen Medis Tabung 1m3' },
  ...
  const products = [
    ...
    { name: 'Refill Tabung 0,3m³', sku: 'RFL-03M3', description: 'Refill isi ulang gas oksigen tabung 0.3m3', price: 25000.0, cost: 15000.0, currentStock: 50, minStock: 5, categoryId: gasCat.id },
    { name: 'Refill Tabung 0,5m³', sku: 'RFL-05M3', description: 'Refill isi ulang gas oksigen tabung 0.5m3', price: 25000.0, cost: 15000.0, currentStock: 50, minStock: 5, categoryId: gasCat.id },
    { name: 'Refill Tabung 1m³', sku: 'RFL-1M3', description: 'Refill isi ulang gas oksigen tabung 1m3', price: 50000.0, cost: 25000.0, currentStock: 50, minStock: 5, categoryId: gasCat.id },
